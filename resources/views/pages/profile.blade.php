...
<div class="container pb-[4rem]">
  ...
  <section class="border-t-2 border-slate-200 mt-10">
    <ul class="flex justify-around mt-5">
      <li class="cursor-pointer pb-3 border-b-2 border-slate-300"><img src="{{ asset('assets/icons/pixels.png') }}" alt="grid" width="25" height="25" /></li>
      <li><img src="{{ asset('assets/icons/sort.png') }}" alt="grid" height="25" width="27" /></li>
    </ul>
  </section>
</div>
@endsection
